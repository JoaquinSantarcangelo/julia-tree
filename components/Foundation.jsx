...
const Fundation = () => {
    return (
        <div className="impact">
            <h2 className="title">An initiative of</h2>
            <div className="wrapper">
                <div className="item">
                    <img src="/assets/img/48.png" alt=""/>
                    <h3 className="item-title">Hopes Initiatives International</h3>
                    <p className="item-paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem optio, quisquam magnam laboriosam explicabo temporibus quis impedit tempore adipisci, ut, voluptas distinctio nulla recusandae omnis minima doloremque. Dolor, magnam ipsum.</p>
                </div>
                <div className="item">
                    <img src="/assets/img/48.png" alt=""/>
                    <h3 className="item-title">Tutu Teach Fundation</h3>
                    <p className="item-paragraph">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil veritatis voluptas animi ab magnam. Repudiandae nobis minima sed? Maiores enim aspernatur doloribus quis, exercitationem provident et corporis dolores quisquam quaerat culpa alias laboriosam reprehenderit quod!</p>
                </div>
                <div className="item">
                    <img src="/assets/img/48.png" alt=""/>
